  ...
  return (
    <nav className="bg-white/90 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-secondary/20">
      <div className="container mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
        ...
        <Link
          to="/"
          className="flex items-center gap-3 text-xl md:text-2xl font-bold tracking-wider hover:text-primary transition group"
        >
          <div className="p-2 bg-primary rounded-full group-hover:bg-primary/20 transition">
            <img
              src="/logo.png"
              alt="COCO Hotel Logo"
