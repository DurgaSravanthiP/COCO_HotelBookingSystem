    ...
    <div className="font-sans text-dark bg-white">
      ...
      <section className="pt-24 pb-12 text-center container mx-auto px-4 animate-fade-in-up overflow-hidden">
        ...
        <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
          Discover a sanctuary of peace and luxury. Your perfect getaway awaits
          where the ocean meets the sky.
        </p>
        <div className="mt-8">
          <Link
            to="/rooms"
            className="inline-flex items-center gap-3 bg-primary text-white px-8 py-3 rounded-full font-bold hover:bg-secondary transition-colors duration-300 shadow-lg hover:shadow-xl"
          >
        ...
        <div className="container mx-auto px-4 mt-12">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 animate-fade-in-up">
              <span className="text-amber-600 font-bold uppercase tracking-widest text-2xl mb-4 block">
                ABOUT US
              </span>
              <h2 className="text-5xl font-serif font-bold text-darkest mb-6">
                Redefining Luxury <br /> & Comfort
              </h2>
              <p className="text-gray-600 leading-relaxed mb-8 text-lg">
                Since 2020, we have been helping travelers find their perfect
                stay. Blending seamless technology with a love for discovery, we
                turn your travel dreams into real-world adventures.
              </p>
            ...
            <div className="flex-1 relative animate-scale-in">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl max-w-xs hidden md:block">
                ...
                <p className="text-xs text-gray-500">
                  "The best hotel experience I've ever had. Highly recommended!"
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-serif font-bold text-darkest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {facilities.map((facility, idx) => (
              <div
                key={idx}
                className="text-center p-8 rounded-2xl hover:bg-light transition-all duration-300 hover-lift group"
              >
                <facility.icon className="text-5xl text-primary mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-xl font-bold text-darkest mb-2">
                  {facility.title}
                </h3>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-light">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link
              to="/rooms"
              className="hidden md:flex items-center gap-2 text-primary font-bold hover:underline hover:gap-4 transition-all"
            >
            ...
            {[
              ...
              >
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-bold text-darkest mb-1 group-hover:text-primary transition">
                      {room.title}
                    </h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, idx) => (
              <div
                key={idx}
                className="bg-light p-8 rounded-2xl hover-lift relative"
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h4 className="font-bold text-darkest">
                      {testimonial.name}
                    </h4>
      ...
      <section className="py-20 bg-gradient-to-r from-primary via-secondary to-primary animate-gradient">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Book now and experience luxury like never before. Special offers
            available for early bookings.
          </p>
          <Link
            to="/rooms"
            className="inline-flex items-center gap-3 bg-white text-primary px-10 py-4 rounded-full font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300"
          >
